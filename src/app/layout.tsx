  ...
  return (
    <html lang="en" className="">
      <head>
        ...
        <meta property="og:title" content="DentalTrack - Simplify Your Dental Appointment Scheduling" />
        <meta property="og:description" content="DentalTrack simplifies dental appointments scheduling & reminders, empowering dentists to manage their practice with ease. Sign up now for customizable schedules, automated reminders & secure patient records. Elevate your dental practice with DentalTrack." />
