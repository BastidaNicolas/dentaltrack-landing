...
export default function XlCard({content, colors, image, reverse}:XlCardType) {
  return (
    <div className="relative w-full md:grid md:grid-cols-12 items-center mb-12 md:mb-36 ">
      <div className={`z-10 relative flex flex-col items-center md:border-2 md:border-black ${colors.mediaquery} md:rounded-2xl md:grid md:grid-cols-11 ${reverse ? 'md:col-start-1 col-end-12':'md:col-start-2 col-end-13'} py-6 md:py-16`}>
